  ...
  return (
    <section className="flex min-h-[70vh] items-center justify-center px-5 py-20">
      <form onSubmit={submit} className="card w-full max-w-[400px]">
        <span className="icon-grad mx-auto mb-5 flex h-12 w-12 text-[24px]"><Icon name="handshake" /></span>
        <h1 className="mb-1 text-center text-[22px] font-bold text-white">Partner portal</h1>
